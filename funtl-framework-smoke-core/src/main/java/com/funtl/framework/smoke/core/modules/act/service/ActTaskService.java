...
package com.funtl.framework.smoke.core.modules.act.service;
...
import com.funtl.framework.smoke.core.modules.act.dao.ActDao;
import com.funtl.framework.smoke.core.modules.act.entity.Act;
import com.funtl.framework.smoke.core.modules.act.service.cmd.CreateAndTakeTransitionCmd;
import com.funtl.framework.smoke.core.modules.act.service.cmd.JumpTaskCmd;
import com.funtl.framework.smoke.core.modules.act.service.creator.ChainedActivitiesCreator;
import com.funtl.framework.smoke.core.modules.act.service.creator.MultiInstanceActivityCreator;
import com.funtl.framework.smoke.core.modules.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import com.funtl.framework.smoke.core.modules.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
import com.funtl.framework.smoke.core.modules.act.utils.ActUtils;
import com.funtl.framework.smoke.core.modules.act.utils.ProcessDefCache;
...
public class ActTaskService extends BaseService {
	...
	public void taskBack(TaskEntity currentTaskEntity, Map<String, Object> variables) {
		ActivityImpl activity = (ActivityImpl) ProcessDefUtils.getActivity(processEngine, currentTaskEntity.getProcessDefinitionId(), currentTaskEntity.getTaskDefinitionKey()).getIncomingTransitions().get(0).getSource();
	...
	public void taskForward(TaskEntity currentTaskEntity, Map<String, Object> variables) {
		ActivityImpl activity = (ActivityImpl) ProcessDefUtils.getActivity(processEngine, currentTaskEntity.getProcessDefinitionId(), currentTaskEntity.getTaskDefinitionKey()).getOutgoingTransitions().get(0).getDestination();
