                                                        ...
                                                        <div class="list-todo-item">
                                                            <a class="list-toggle-container font-white" data-toggle="collapse" href="#task-${p.index}" aria-expanded="true">
                                                                <div class="list-toggle done uppercase version-click-bg well font-red-mint" title="点击展开或收起"
                                                                     style="padding: 3px 10px 3px 10px;color: black;background-color: #DEE5EC !important;">
                                                                    <div class="list-toggle-title ${v.currentVersion}" style="width:35%;padding-left: 10px; line-height: 34px;">
                                                                    ...
                                                                    <div style="display: inline-block;">
                                                                        ...
                                                                        <button id="now-update-version" class="btn blue" ${not empty v.currentVersion?'disabled':''} >
                                                                            ${fns:showButtonName(v.inVerNo)}
                                                                        </button>
                                                                        <input value="${v.inVerNo}" type="hidden" />
                                                                        <input value="${v.exVerNo}" type="hidden" />
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="list-todo-item">
                                                            <a class="list-toggle-container font-white collapsed" data-toggle="collapse" href="#task-${p.index}" aria-expanded="false">
                                                                <div class="list-toggle done uppercase version-click-bg" title="点击展开或收起"
                                                                    ...
                                                                    <div class="list-toggle-title" style="padding-left: 10px;width: 35%;line-height: 34px;">
                                                                    ...
                                                                    <div style="display: inline-block;">
                                                                        <button id="now-rollback-version" class="btn default" ${not empty v.currentVersion?'disabled':''} >
                                                                                ${fns:showButtonName(v.inVerNo)}
                                                                        </button>
                                                                        <input value="${v.inVerNo}" type="hidden" />
                                                                        <input value="${v.exVerNo}" type="hidden" />
                                ...
                                <div class="mt-list-container list-todo" style="border: none;">
                                    ...
                                    <ul >
                                        <li class="mt-list-item" >
                                            ...
                                            <div class="list-todo-item">
                                                <div class="list-toggle-container font-white" >
                                                    <div class="list-toggle done uppercase well font-red-mint" style="padding: 3px 10px 3px 10px;">
                                                        <div class="list-toggle-title" style="width:35%;padding-left: 10px;height: 40px;line-height: 40px;color: black;">
                                                            我的版本：${fns:versionName()}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="mt-list-container list-todo" style="border: none;">
                                    ...
                                    <ul >
                                        <li class="mt-list-item" >
                                            ...
                                            <div class="list-todo-item">
                                                <div class="list-toggle-container font-white" >
                                                    <div class="list-toggle done uppercase well font-red-mint" style="padding: 3px 10px 3px 10px;color: black;">
...
<script type="text/javascript">
    ...
    //# 立即更新
    function clickNowUpdate() {
        $('#now-update-version').bind('click', function (event) {
            $("body").remove('#upVersionForm');
            event.stopPropagation();
            var innerVersion = $(this).siblings('input').eq(0).val();
            var _htmlText = "<form id='upVersionForm' method='post' action='${ctx}/sys/version/update/upgrade'>" +
                "<input type='hidden' name='inVerNo' value='"+innerVersion+"' />" ;
            $("body").append(_htmlText);
            $('#upVersionForm').submit();
        });
    }

    //# 立即回退
    function clickNowRollback() {
        $('#now-rollback-version').bind('click', function (event) {
            $("body").remove('#downVersionForm');
            event.stopPropagation();
            var innerVersion = $(this).siblings('input').eq(0).val();
            var _htmlText = "<form id='downVersionForm' method='post' action='${ctx}/sys/version/update/rollback'>" +
                "<input type='hidden' name='inVerNo' value='"+innerVersion+"' />" ;
            $("body").append(_htmlText);
            $('#downVersionForm').submit();
        });
    }
